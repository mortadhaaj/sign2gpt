...
def get_config():
    ...
    cfg.project_name = "final_isharah_selfie"
    ...
    cfg.train_ds_name = "dataloaders.isharah_selfie_video_dataset"
    cfg.valid_ds_name = "dataloaders.isharah_selfie_video_dataset"
    cfg.test_ds_name = "dataloaders.isharah_selfie_video_dataset"
    train_ds_params = {
        "split": "train",
        "sep": ",",
        ...
        "ds_params": {
            "lmdb_video_dir": f"{code_path}/{lmdb_path}",
            "isValid": False,
        },
        "shuffle": True,
    ...
    cfg.pretext = ""
    cfg.replacement_pickle = f"{code_path}/data/isharah_selfie/isharah_selfie_replacements.pkl"
    
    cfg.stage1_name = "configs.isharah_selfie.isharah_selfie_stage1_configs.isharah_selfie_example_s1_config"
